...
if (-not ($SOAPY_SDR_TARGET | Test-Path)) {
    ...
    cmake -B "$SOAPY_SDR_TARGET" -G "$CS_GENERATOR" -A $CS_BUILD_ARCH "$SOAPY_SDR_SOURCE" -DCMAKE_INSTALL_PREFIX="$SOAPY_SDR_INSTALL" -DENABLE_PYTHON=OFF -DENABLE_PYTHON3=OFF
