...
if (-not ($AIRSPYHF_HOST_SOURCES | Test-Path)) {
    Get-PinnedSource https://github.com/airspy/airspyhf $AIRSPYHF_HOST_SOURCES
}
...
if (-not ($SOAPY_AIRSPYHF_SOURCES | Test-Path)) {
    Get-PinnedSource https://github.com/pothosware/SoapyAirspyHF $SOAPY_AIRSPYHF_SOURCES
}
